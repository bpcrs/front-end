...
import { postCarSubmit, fetchBrandList, fetchModelList, postCar } from "./booking.action";
    ...
    return (
        <Layout name="Car renting form">
            ...
            <div>
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">{"Uploading Car"}</DialogTitle>
                    <DialogContent>
                ...
                <Grid item lg={5} xs={12}>
                    ...
                    <Grid item xs={12} sm={6} lg={10}>
                        <Card className={classes.card}>
                                        ...
                                        >
                                            {
                                                brands.map((brand) => (
                                                    <MenuItem key={brand.name} value={brand}>
                                                        <img className={classes.icon} src={brand.logoLink} alt="" />
                            ...
                            <Grid item xs={12} lg={12}>
                                <FormControl className={classes.formControl}>
                                    <InputLabel id="demo-simple-select-required-label" variant="outlined">Auto Drive</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-required-label"
                                        id="txtAutoDriver"
