                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12} xl={6} justify="flex-end" container >
                                <FormControl fullWidth className={classes.spacingCard}>
                                    <TextField id="pickup-basic" label="Pickup" variant="outlined" fullWidth value="FPT University, District 9, Ho Chi Minh City" />
                                </FormControl>
                                <FormControl fullWidth className={classes.spacingCard}>
                                    <TextField id="destinaion-basic" label="Destinaion" variant="outlined" fullWidth value="Vung Tau City" />
                                </FormControl>
                            </Grid>
                        </Grid>
                    </CardContent>
                ...
                <Grid container className={classes.root} spacing={2} justify="center">
                    <Grid item xs={12} lg={12} xl={12} className={classes.paper}>
                        <FormControlLabel
                            ...
                            label={<div><span>I am over 21 years old, I agree to all </span><Link href="#" to="/" variant="body2">Terms & Conditions</Link></div>}
                        />
                    </Grid>
